...
* [django-project-stub](https://github.com/pahaz/django-project-stub) - A boilerplate with FlatUI, Celery, pytest, code style checkers and Dokku / Heroku ready deploy and much more. Ideal for new Django project
